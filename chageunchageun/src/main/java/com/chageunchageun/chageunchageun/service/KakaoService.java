...
import com.chageunchageun.chageunchageun.controller.MemoirController;
...
public class KakaoService {
    ...
    public String getAccessToken(String code){
        ...
        try {
            ...
            sb.append("&redirect_uri=http://localhost:8080/api/v1/auth/KakaoLogin");
            sb.append("&code=" + code);
    ...
    public KakaoDTO getUserInfo(String access_Token){
        ...
        try {
            ...
            log.info("\n");
            log.info("log = {}", properties);
            log.info("log = {}", kakao_account);
